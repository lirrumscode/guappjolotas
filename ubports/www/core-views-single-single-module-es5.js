(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["core-views-single-single-module"], {
    ...
    /***/
    function Abs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      SinglePageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _single_routing_module__WEBPACK_IMPORTED_MODULE_5__["SinglePageRoutingModule"]],
    ...
    /***/
    function c0SZ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function wzJk(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_single_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./single.page.html */
      "52BK");
      /* harmony import */


      var _single_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./single.page.scss */
      "C+X7");
      /* harmony import */
      ...
      var SinglePage = /*#__PURE__*/function () {
        function SinglePage(router, route, dto, toastController) {
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      _context.prev = 0;
                      _context.next = 3;
                      return this.dto.getDataGuajalopas().subscribe(function (data) {
                        var items = data.find(function (item) {
                          return item.id === parseInt(_this2.id.id);
                        });
                        _this2.dataObject = items; // return this.dataObject;
                      });
      ...
      SinglePage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
        selector: 'app-single',
...
//# sourceMappingURL=core-views-single-single-module-es5.js.map