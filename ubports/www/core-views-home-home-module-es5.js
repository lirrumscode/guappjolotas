(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["core-views-home-home-module"], {
    ...
    /***/
    function lfc(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function F4NX(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function TVGC(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function bJlj(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function r3xG(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var HomePage = /*#__PURE__*/function () {
        function HomePage(router, dto, toastController) {
        ...
        _createClass(HomePage, [{
          ...
          key: "goToSingle",
          value: function goToSingle(item) {
            this.router.navigate(['/single', item.id]);
          }
        }, {
          key: "goToSingleBebidas",
          value: function goToSingleBebidas(item) {
            this.router.navigate(['/single/bebidas/', item.id]);
          }
        }, {
          key: "goToSingleTamales",
          value: function goToSingleTamales(item) {
            this.router.navigate(['/single/tamales/', item.id]);
          }
        }, {
          key: "getGuajalopas",
          value: function getGuajalopas() {
...
//# sourceMappingURL=core-views-home-home-module-es5.js.map